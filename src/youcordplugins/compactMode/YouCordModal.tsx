...
const TABS: TabDef[] = [
    ...
    },
    {
        ...
        description: "Sync YouCord settings across devices",
    },
    {
        id: "language",
        label: "Language",
        ...
        description: "Change YouCord's interface language",
    },
];
    ...
    return (
        <ModalRoot {...modalProps} size={ModalSize.LARGE} className="nc-modal-wrapper">
            <ModalContent className="nc-modal-modal-content">
                <ErrorBoundary message="Failed to render YouCord Settings modal.">
                    <YouCordModalInner onClose={modalProps.onClose} />
                </ErrorBoundary>
            </ModalContent>
        </ModalRoot>
    );
...
export function openYouCordModal() {
    openModal(modalProps => <YouCordModal modalProps={modalProps} />);
}
