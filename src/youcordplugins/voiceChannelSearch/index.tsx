...
import { Forms, GuildChannelStore, GuildStore, IconUtils, React, useEffect, useMemo, useRef, UserStore, useState,VoiceStateStore } from "@webpack/common";
...
export default definePlugin({
    ...
    start() {
        addHeaderBarButton("youcord-voice-channel-search", () => <VCSHeaderButton />, 9);
    },
    stop() {
        removeHeaderBarButton("youcord-voice-channel-search");
        scanCache = null;
    },
});
