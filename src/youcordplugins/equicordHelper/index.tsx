...
export default definePlugin({
    name: "YouCordHelper",
    description: "Main YouCord plugin: fixes Discord crashes, adds UI options and manages internal commands.",
    authors: [
        Devs.thororen,
        EquicordDevs.nyx,
        EquicordDevs.Naibuu,
    ...
    flux: {
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    title: "YouCord Support Channel Warning",
                    body: "Before asking for help. Check updates and if this issue is actually caused by YouCord!",
                    confirmText: "YouCord Support",
                    onConfirm() {
