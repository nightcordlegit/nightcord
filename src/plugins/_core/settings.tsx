...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the YouCord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const fullEntries: SettingsLayoutNode[] = [
            ...
            buildEntry({
                ...
                panelTitle: "YouCord Sync",
                Component: SyncTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "youcord_language",
                title: "Language",
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("YouCord_stealthMode") === "1") return ""; } catch { }
                return t("YouCord Settings");
            },
            buildLayout: () => {
                try { if (localStorage.getItem("YouCord_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`YouCord ${gitHashShort}${getVersionInfo()}`];
