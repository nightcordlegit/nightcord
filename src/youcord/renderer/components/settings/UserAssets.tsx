...
import { BaseText, Button, FormSwitch } from "@YouCord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@YouCord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`youcord://assets/${asset}?v=${version}`}
                    alt=""
