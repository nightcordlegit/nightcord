...
import { useState } from "@YouCord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start YouCord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start YouCord minimized when starting with system"}
