...
import { Heading, Paragraph } from "@YouCord/types/components";
import { Margins } from "@YouCord/types/utils";
import { Select } from "@YouCord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind YouCord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
