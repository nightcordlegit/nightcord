...
import { BaseText } from "@YouCord/types/components";
import { React, useRef, useState } from "@YouCord/types/webpack/common";
...
function cleanForYouCord(json: any): any {
    ...
    async function processFile(file: File) {
        ...
        try {
            ...
            const sourceLabel =
                ...
                source === "youcord" ? "YouCord" : "inconnu";
    ...
    return (
        <div className={cl("category")}>
            ...
            <BaseText size="sm" style={{ marginBottom: "12px", opacity: 0.7 }}>
                Drag & drop your Equicord or Vencord backup JSON file here to import your settings into YouCord.
                Plugin-specific settings that don't exist in YouCord will be automatically removed.
            </BaseText>
