...
import { Button, Card, HeadingTertiary, Paragraph } from "@YouCord/types/components";
import { useAwaiter } from "@YouCord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your YouCord is outdated!</HeadingTertiary>
