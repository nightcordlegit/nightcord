...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@YouCord/types/components";
import { FluxDispatcher, InviteActions } from "@YouCord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure YouCord and YouCord are fully up to date. You can get help in our{" "}
