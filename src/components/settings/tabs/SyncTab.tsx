...
const BADGE_OPTIONS: Array<{ label: string; value: BadgeSource }> = [
    { label: "YouCord Badges", value: "youcord" },
...
function renderPrefix(option: { value: BadgeSource }) {
    switch (option.value) {
        case "youcord": return <YouCordIcon />;
    ...
    return (
        <div style={{ marginBottom: 16 }}>
            <FormSwitch
                ...
                title={t("YouCord Sync")}
                description={isEnabled
                    ? t("Your custom profile is synced. Other YouCord users can see your profile, and you can see theirs.")
                    : t("Enable to share your custom profile with other YouCord users and see their profiles.")}
                disabled={busy}
            />
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {t("YouCord's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.")}
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                {t("We use our own YouCord Cloud backend with enhanced features.")}
                {" "}
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    renderOptionPrefix={o => {
                        if (o?.value?.includes("youcord")) return <YouCordIcon />;
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Synchronize your YouCord settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.")}
            </Paragraph>
