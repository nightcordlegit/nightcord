...
const YOUCORD_ICON_B64 = "https://i.ibb.co/R4HWcpYH/Chat-GPT-Image-12-juil-2026-19-31-03-removebg-preview.png";

function YouCordIcon() {
    return <img src={YOUCORD_ICON_B64} alt="YouCord" style={ICON_STYLE} />;
}
        ...
        <SettingsTab>
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    closeOnSelect={true}
                    renderOptionPrefix={o => o?.value?.includes("youcord") ? <YouCordIcon /> : o?.value?.includes("equicord") ? <EquicordIcon /> : <VencordIcon />}
                />
            </div>
