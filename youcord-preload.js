// YouCord preload â€” globalPaths fix + Equicord avec contextBridge
"use strict";
    ...
    try {
        ...
        if (rendererJs) {
            webFrame.executeJavaScript(rendererJs).catch(e => {
                console.error("[YouCord] renderer inject failed:", e?.message);
            });
        }
    } catch (e) {
        console.error("[YouCord] VencordPreloadGetRendererJs failed:", e);
    }
